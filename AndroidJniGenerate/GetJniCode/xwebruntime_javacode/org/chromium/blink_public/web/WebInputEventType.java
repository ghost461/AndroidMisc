...
@Retention(value=RetentionPolicy.SOURCE) @public interface WebInputEventType {
    ...
    public static final int POINTER_CANCEL = 36;
    public static final int POINTER_CAUSED_UA_ACTION = 37;
