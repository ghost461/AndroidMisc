...
public final class Value extends Union {
    ...
    public static final Value decode(Decoder arg3, int arg4) {
        ...
        switch(v0.elementsOrVersion) {
            case 0: {
                v1.mNullValue = arg3.readByte(arg4 + 8);
                v1.mTag = 0;
                break;
            }
            case 1: {
                v1.mBoolValue = arg3.readBoolean(arg4 + 8, 0);
                v1.mTag = 1;
                break;
            }
            case 2: {
                v1.mIntValue = arg3.readInt(arg4 + 8);
                v1.mTag = 2;
                break;
            }
            case 3: {
                v1.mDoubleValue = arg3.readDouble(arg4 + 8);
                v1.mTag = 3;
                break;
            }
            case 4: {
                v1.mStringValue = arg3.readString(arg4 + 8, false);
                v1.mTag = 4;
                break;
            }
            case 5: {
                v1.mBinaryValue = arg3.readBytes(arg4 + 8, 0, -1);
                v1.mTag = 5;
                break;
            }
            case 6: {
                v1.mDictionaryValue = DictionaryValue.decode(arg3.readPointer(arg4 + 8, false));
                v1.mTag = 6;
                break;
            }
            case 7: {
                v1.mListValue = ListValue.decode(arg3.readPointer(arg4 + 8, false));
                v1.mTag = 7;
                break;
            }
            default: {
    ...
    protected final void encode(Encoder arg4, int arg5) {
        ...
        switch(this.mTag) {
            case 0: {
                arg4.encode(this.mNullValue, arg5 + 8);
                break;
            }
            case 1: {
    ...
    public void setNullValue(byte arg2) {
        this.mTag = 0;
