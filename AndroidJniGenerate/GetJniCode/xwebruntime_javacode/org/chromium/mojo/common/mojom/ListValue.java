...
public final class ListValue extends Struct {
    ...
    public static ListValue decode(Decoder arg7) {
        ...
        try {
            ...
            v1.values = new Value[v4.elementsOrVersion];
            while(v0_1 < v4.elementsOrVersion) {
                v1.values[v0_1] = Value.decode(v3, v0_1 * 16 + v2);
                ++v0_1;
            }
        }
        catch(Throwable v0) {
    ...
    protected final void encode(Encoder arg6) {
        ...
        if(this.values == null) {
            ...
            arg6 = arg6.encodeUnionArray(this.values.length, v2, -1);
            int v0;
            for(v0 = 0; v0 < this.values.length; ++v0) {
                arg6.encode(this.values[v0], v0 * 16 + v2, false);
            }
        }
    }
}
