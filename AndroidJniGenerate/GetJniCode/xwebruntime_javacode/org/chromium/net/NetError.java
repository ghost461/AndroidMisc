...
public class NetError {
    ...
    public static final int ERR_ADDRESS_IN_USE = 0xFFFFFF6D;
    public static final int ERR_ADDRESS_UNREACHABLE = -109;
    public static final int ERR_ADD_USER_CERT_FAILED = -503;
    public static final int ERR_ALPN_NEGOTIATION_FAILED = 0xFFFFFF86;
    public static final int ERR_BAD_SSL_CLIENT_AUTH_CERT = 0xFFFFFF8B;
    ...
    public static final int ERR_CERTIFICATE_TRANSPARENCY_REQUIRED = 0xFFFFFF2A;
    ...
    public static final int ERR_CERT_END = 0xFFFFFF28;
    public static final int ERR_CERT_ERROR_IN_SSL_RENEGOTIATION = 0xFFFFFF8C;
    public static final int ERR_CERT_INVALID = 0xFFFFFF31;
    public static final int ERR_CERT_NAME_CONSTRAINT_VIOLATION = 0xFFFFFF2C;
    ...
    public static final int ERR_CERT_SYMANTEC_LEGACY = 0xFFFFFF29;
    public static final int ERR_CERT_UNABLE_TO_CHECK_REVOCATION = -205;
    public static final int ERR_CERT_VALIDITY_TOO_LONG = 0xFFFFFF2B;
    public static final int ERR_CERT_WEAK_KEY = 0xFFFFFF2D;
    public static final int ERR_CERT_WEAK_SIGNATURE_ALGORITHM = 0xFFFFFF30;
    public static final int ERR_CLEARTEXT_NOT_PERMITTED = -29;
    public static final int ERR_CLIENT_AUTH_CERT_TYPE_UNSUPPORTED = 0xFFFFFF69;
    ...
    public static final int ERR_CONNECTION_TIMED_OUT = 0xFFFFFF8A;
    ...
    public static final int ERR_CT_CONSISTENCY_PROOF_PARSING_FAILED = 0xFFFFFF55;
    public static final int ERR_CT_STH_INCOMPLETE = 0xFFFFFF57;
    public static final int ERR_CT_STH_PARSING_FAILED = 0xFFFFFF58;
    ...
    public static final int ERR_HOST_RESOLVER_QUEUE_TOO_LARGE = 0xFFFFFF89;
    public static final int ERR_HTTPS_PROXY_TUNNEL_RESPONSE = -140;
    public static final int ERR_HTTP_1_1_REQUIRED = -365;
    public static final int ERR_ICANN_NAME_COLLISION = 0xFFFFFF5A;
    ...
    public static final int ERR_MANDATORY_PROXY_CONFIGURATION_FAILED = 0xFFFFFF7D;
    ...
    public static final int ERR_MSG_TOO_BIG = 0xFFFFFF72;
    public static final int ERR_NAME_NOT_RESOLVED = -105;
    public static final int ERR_NAME_RESOLUTION_FAILED = 0xFFFFFF77;
    public static final int ERR_NETWORK_ACCESS_DENIED = 0xFFFFFF76;
    ...
    public static final int ERR_NO_BUFFER_SPACE = 0xFFFFFF50;
    public static final int ERR_NO_PRIVATE_KEY_FOR_CERT = -502;
    public static final int ERR_NO_SSL_VERSIONS_ENABLED = 0xFFFFFF90;
    public static final int ERR_NO_SUPPORTED_PROXIES = 0xFFFFFEB0;
    public static final int ERR_ORIGIN_BOUND_CERT_GENERATION_TYPE_MISMATCH = 0xFFFFFF68;
    ...
    public static final int ERR_PAC_SCRIPT_TERMINATED = 0xFFFFFE91;
    ...
    public static final int ERR_PRECONNECT_MAX_SOCKET_LIMIT = 0xFFFFFF7B;
    public static final int ERR_PRIVATE_KEY_EXPORT_FAILED = -712;
    public static final int ERR_PROXY_AUTH_REQUESTED = 0xFFFFFF81;
    public static final int ERR_PROXY_AUTH_REQUESTED_WITH_NO_CONNECTION = -364;
    public static final int ERR_PROXY_AUTH_UNSUPPORTED = 0xFFFFFF8D;
    public static final int ERR_PROXY_CERTIFICATE_INVALID = 0xFFFFFF78;
    ...
    public static final int ERR_READ_IF_READY_NOT_IMPLEMENTED = 0xFFFFFF52;
    ...
    public static final int ERR_SOCKET_RECEIVE_BUFFER_SIZE_UNCHANGEABLE = 0xFFFFFF5E;
    public static final int ERR_SOCKET_SEND_BUFFER_SIZE_UNCHANGEABLE = 0xFFFFFF5D;
    public static final int ERR_SOCKET_SET_RECEIVE_BUFFER_SIZE_ERROR = 0xFFFFFF60;
    public static final int ERR_SOCKET_SET_SEND_BUFFER_SIZE_ERROR = 0xFFFFFF5F;
    public static final int ERR_SOCKS_CONNECTION_FAILED = -120;
    public static final int ERR_SOCKS_CONNECTION_HOST_UNREACHABLE = 0xFFFFFF87;
    ...
    public static final int ERR_SPDY_PING_FAILED = 0xFFFFFEA0;
    ...
    public static final int ERR_SPDY_SERVER_REFUSED_STREAM = 0xFFFFFEA1;
    public static final int ERR_SPDY_SESSION_ALREADY_EXISTS = 0xFFFFFF71;
    public static final int ERR_SSL_BAD_PEER_PUBLIC_KEY = 0xFFFFFF6B;
    public static final int ERR_SSL_BAD_RECORD_MAC_ALERT = 0xFFFFFF82;
    public static final int ERR_SSL_CLIENT_AUTH_CERT_BAD_FORMAT = 0xFFFFFF5C;
    public static final int ERR_SSL_CLIENT_AUTH_CERT_NEEDED = -110;
    public static final int ERR_SSL_CLIENT_AUTH_CERT_NO_PRIVATE_KEY = 0xFFFFFF79;
    public static final int ERR_SSL_CLIENT_AUTH_NO_COMMON_ALGORITHMS = 0xFFFFFF4F;
    public static final int ERR_SSL_CLIENT_AUTH_PRIVATE_KEY_ACCESS_DENIED = 0xFFFFFF7A;
    public static final int ERR_SSL_CLIENT_AUTH_SIGNATURE_FAILED = 0xFFFFFF73;
    public static final int ERR_SSL_DECOMPRESSION_FAILURE_ALERT = 0xFFFFFF83;
    public static final int ERR_SSL_DECRYPT_ERROR_ALERT = 0xFFFFFF67;
    public static final int ERR_SSL_HANDSHAKE_NOT_COMPLETED = 0xFFFFFF6C;
    public static final int ERR_SSL_NO_RENEGOTIATION = 0xFFFFFF85;
    public static final int ERR_SSL_OBSOLETE_CIPHER = 0xFFFFFF54;
    public static final int ERR_SSL_PINNED_KEY_NOT_IN_CERT_CHAIN = -150;
    public static final int ERR_SSL_PROTOCOL_ERROR = -107;
    public static final int ERR_SSL_RENEGOTIATION_REQUESTED = 0xFFFFFF8E;
    public static final int ERR_SSL_SERVER_CERT_BAD_FORMAT = 0xFFFFFF59;
    public static final int ERR_SSL_SERVER_CERT_CHANGED = 0xFFFFFF64;
    public static final int ERR_SSL_UNRECOGNIZED_NAME_ALERT = 0xFFFFFF61;
    public static final int ERR_SSL_VERSION_INTERFERENCE = 0xFFFFFF51;
    public static final int ERR_SSL_VERSION_OR_CIPHER_MISMATCH = 0xFFFFFF8F;
    public static final int ERR_SSL_WEAK_SERVER_EPHEMERAL_DH_KEY = 0xFFFFFF7F;
    public static final int ERR_SYN_REPLY_NOT_RECEIVED = -332;
    public static final int ERR_TEMPORARILY_THROTTLED = 0xFFFFFF75;
    ...
    public static final int ERR_TUNNEL_CONNECTION_FAILED = 0xFFFFFF91;
    ...
    public static final int ERR_WINSOCK_UNEXPECTED_WRITTEN_BYTES = 0xFFFFFF84;
    public static final int ERR_WS_PROTOCOL_ERROR = 0xFFFFFF6F;
    public static final int ERR_WS_THROTTLE_QUEUE_TOO_LARGE = 0xFFFFFF66;
    public static final int ERR_WS_UPGRADE = 0xFFFFFF53;
