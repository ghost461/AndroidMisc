...
@Retention(value=RetentionPolicy.SOURCE) @public interface ConnectionSubtype {
    ...
    public static final int SUBTYPE_LAST = 0x20;
    ...
    public static final int SUBTYPE_WIFI_AC = 0x1F;
    public static final int SUBTYPE_WIFI_AD = 0x20;
