...
@Retention(value=RetentionPolicy.SOURCE) @public interface VideoCodecProfile {
    public static final int AV1PROFILE_MAX = 24;
    public static final int AV1PROFILE_MIN = 24;
    public static final int AV1PROFILE_PROFILE0 = 24;
    public static final int DOLBYVISION_MAX = 22;
    ...
    public static final int VIDEO_CODEC_PROFILE_MAX = 24;
