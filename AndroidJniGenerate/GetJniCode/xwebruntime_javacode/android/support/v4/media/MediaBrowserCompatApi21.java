...
@RequiresApi(value=21) class MediaBrowserCompatApi21 {
    ...
    class MediaItem {
        ...
        public static Object getDescription(Object arg0) {
            return ((MediaBrowser$MediaItem)arg0).getDescription();
        }

        public static int getFlags(Object arg0) {
            return ((MediaBrowser$MediaItem)arg0).getFlags();
        }
    }
    ...
    public static Bundle getExtras(Object arg0) {
        return ((MediaBrowser)arg0).getExtras();
    }

    public static String getRoot(Object arg0) {
        return ((MediaBrowser)arg0).getRoot();
    }

    public static ComponentName getServiceComponent(Object arg0) {
        return ((MediaBrowser)arg0).getServiceComponent();
    }

    public static Object getSessionToken(Object arg0) {
        return ((MediaBrowser)arg0).getSessionToken();
    }

    public static boolean isConnected(Object arg0) {
        return ((MediaBrowser)arg0).isConnected();
    }
