...
public final class FingerprintManagerCompat {
    @RequiresApi(value=23) class Api23FingerprintManagerCompatImpl implements FingerprintManagerCompatImpl {
        ...
        public void authenticate(Context arg7, CryptoObject arg8, int arg9, CancellationSignal arg10, AuthenticationCallback arg11, Handler arg12) {
            ...
            Object v8 = arg10 != null ? arg10.getCancellationSignalObject() : null;
            Object v3 = v8;
            FingerprintManagerCompatApi23.authenticate(arg7, v1, arg9, v3, Api23FingerprintManagerCompatImpl.wrapCallback(arg11), arg12);
        }

        public boolean hasEnrolledFingerprints(Context arg1) {
            return FingerprintManagerCompatApi23.hasEnrolledFingerprints(arg1);
        }

        public boolean isHardwareDetected(Context arg1) {
            return FingerprintManagerCompatApi23.isHardwareDetected(arg1);
        }
        ...
        private static android.support.v4.hardware.fingerprint.FingerprintManagerCompatApi23$AuthenticationCallback wrapCallback(AuthenticationCallback arg1) {
            return new android.support.v4.hardware.fingerprint.FingerprintManagerCompatApi23$AuthenticationCallback(arg1) {
                ...
                public void onAuthenticationSucceeded(AuthenticationResultInternal arg3) {
                    this.val$callback.onAuthenticationSucceeded(new AuthenticationResult(Api23FingerprintManagerCompatImpl.unwrapCryptoObject(arg3.getCryptoObject())));
                }
            };
        }
        ...
        private static android.support.v4.hardware.fingerprint.FingerprintManagerCompatApi23$CryptoObject wrapCryptoObject(CryptoObject arg2) {
            ...
            if(arg2.getCipher() != null) {
                return new android.support.v4.hardware.fingerprint.FingerprintManagerCompatApi23$CryptoObject(arg2.getCipher());
            }

            if(arg2.getSignature() != null) {
                return new android.support.v4.hardware.fingerprint.FingerprintManagerCompatApi23$CryptoObject(arg2.getSignature());
            }

            if(arg2.getMac() != null) {
                return new android.support.v4.hardware.fingerprint.FingerprintManagerCompatApi23$CryptoObject(arg2.getMac());
            }
